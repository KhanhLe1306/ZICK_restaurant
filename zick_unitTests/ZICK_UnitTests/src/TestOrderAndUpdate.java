...
public class TestOrderAndUpdate {
  ...
  @Test
  public void testOrderAndUpdate() throws Exception {
    ...
    new Select(driver.findElement(By.name("A03_quantity"))).selectByVisibleText("1");
    driver.findElement(By.xpath("//button[@type='submit']")).click();
    driver.get("http://ec2-50-19-192-131.compute-1.amazonaws.com:8080/zick_restaurant/cart.jsp");
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='$15.0'])[1]/following::button[1]")).click();
    driver.get("http://ec2-50-19-192-131.compute-1.amazonaws.com:8080/zick_restaurant/PlaceOrder");
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Shrimp Cocktail |'])[3]/following::button[1]")).click();
