...
public class TestViewCustomers {
  ...
  public void testViewCustomers() throws Exception {
    ...
    driver.get("http://ec2-50-19-192-131.compute-1.amazonaws.com:8080/zick_restaurant/home.jsp");
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Order Now'])[1]/following::button[1]")).click();
    driver.get("http://ec2-50-19-192-131.compute-1.amazonaws.com:8080/zick_restaurant/Admin");
  }
