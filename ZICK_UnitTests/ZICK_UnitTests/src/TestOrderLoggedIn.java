...
public class TestOrderLoggedIn {
  ...
  @Test
  public void testOrderLoggedIn() throws Exception {
    ...
    driver.findElement(By.name("A02_quantity")).click();
    new Select(driver.findElement(By.name("A02_quantity"))).selectByVisibleText("2");
    driver.findElement(By.name("F03_quantity")).click();
    new Select(driver.findElement(By.name("F03_quantity"))).selectByVisibleText("3");
    driver.findElement(By.xpath("//button[@type='submit']")).click();
    driver.get("http://ec2-50-19-192-131.compute-1.amazonaws.com:8080/zick_restaurant/cart.jsp");
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='$75.0'])[1]/following::button[1]")).click();
